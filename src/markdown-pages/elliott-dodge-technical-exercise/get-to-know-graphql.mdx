...
By now, hopefully you've gotten comfortable with the basic features that define GraphQL, querying and mutating data. There are still plenty of powerful features to learn, but you are already well-equipped to handle a variety of data-related needs. 
